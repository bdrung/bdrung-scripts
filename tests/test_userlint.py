...
class TestPerson(unittest.TestCase):
    ...
    def test_name_contains_email(self):
    ...
    def test_empty_email_existing_name(self):
...
class TestUserlint(unittest.TestCase):
    ...
    def test_email_at_localhost(self):
    ...
    def test_user_name_is_nickname(self):
    ...
    def test_main_suggest_mailmap(self):
        with tempfile.TemporaryDirectory(prefix=self.PREFIX) as tmpdir:
            self._prepare_git_repository(tmpdir, "Benjamin Drung", "bdrung@ubuntu.com")
